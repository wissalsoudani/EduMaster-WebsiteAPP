...
class HistoireController extends AbstractController
{
    ...
    /**
     * @Route ("ajouterHistoire", name ="ajouterHistoire")
     */
    ...
    /**
    * @Route ("afficherHistoire",name ="afficherHistoire")
     */
    ...
    /**
     * @Route ("/afficherHistoireF",name ="afficherH")
     */
    ...
    /**
     * @Route("/AllHistoires", name="AllHistoires")
     */
