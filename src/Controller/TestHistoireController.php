...
class TestHistoireController extends AbstractController
{
    ...
    /**
     * @Route ("ajouterTestHistoire", name ="ajouterTestHistoire")
     */
    ...
    /**
     * @Route ("afficherTestHistoire",name ="afficherTestHistoire")
     */
    ...
    {
        $connectedUser = $this->getDoctrine()->getRepository(User::class)->find(30);
